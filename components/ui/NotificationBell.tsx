...
function NotifIcon({ type }: { type: ClientNotification["type"] }) {
  ...
  switch (type) {
    case "PRINT_READY":
      return <div className={`${base} bg-white-500/10 text-gray-600`}>
          <svg 
              viewBox="0 0 24 24" 
              fill="none" 
              stroke="currentColor" 
    ...
    case "PRINTING_STARTED":
      return <div className={`${base} bg-white-500/10 text-gray-600`}>
        <svg 
          ...
          className="w-6 h-6"
        >
          <path strokeLinecap="round" strokeLinejoin="round" d="M6 10h12v9a1 1 0 0 1-1 1H7a1 1 0 0 1-1-1v-9zm0 0V6a1 1 0 0 1 1-1h10a1 1 0 0 1 1 1v4" />
          <path strokeLinecap="round" d="M8 14h8M8 17h8" className="animate-pulse" />
        </svg>
      </div>;
    case "PRINT_CANCELLED":
      return <div className={`${base} bg-white-500/10 text-red-400`}>
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} className="w-6 h-6">
          <path strokeLinecap="round" strokeLinejoin="round" d="M6 18L18 6M6 6l12 12" />
        </svg>
      </div>;
    case "PAYMENT_CONFIRMED":
      return <div className={`${base} bg-white-500/10 text-emerald-400`}>
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} className="w-6 h-6">
    ...
    case "BROADCAST":
      return <div className={`${base} bg-white-500/10 text-gray-600`}>
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} className="w-6 h-6">
          <path strokeLinecap="round" strokeLinejoin="round" d="M10.343 3.957a1 1 0 0 1 1.314.07l5.25 5.25a1 1 0 0 1 0 1.414l-5.25 5.25a1 1 0 0 1-1.314-.07 1 1 0 0 1 0-1.414L14.586 10 10.343 5.743a1 1 0 0 1 0-1.414zM4 10a1 1 0 0 1 1-1h2.586l3.707-3.707a1 1 0 0 1 1.707.707v12a1 1 0 0 1-1.707.707L7.586 15H5a1 1 0 0 1-1-1v-4z" />
        </svg>
      </div>;
    default:
      return <div className={`${base} bg-white-500/10 text-gray-600`}>
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} className="w-6 h-6">
          <path strokeLinecap="round" strokeLinejoin="round" d="M14.857 17.082a23.848 23.848 0 0 0 5.454-1.31A8.967 8.967 0 0 1 18 9.75V9A6 6 0 0 0 6 9v.75a8.967 8.967 0 0 1-2.312 6.022c1.733.64 3.56 1.085 5.455 1.31M14.857 17.082a3 3 0 1 1-5.714 0" />
        </svg>
      </div>;
  }
}
